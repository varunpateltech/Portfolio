...
- **2025 to now**: Staff Product Manager, emnify (Germany)
...
- No em dashes anywhere in this repo's text, generated or existing. Use a period, comma, colon, or parentheses instead. Exception: direct quotes attributed to someone else (e.g. testimonials) are left exactly as given, since editing another person's quoted words changes what they're on record as having said.
